...
class TestHttpsLayer(unittest.TestCase):
    ...
    def setUp(self):
        from client.https import invalidate_cache
        invalidate_cache()

    @patch("requests.request")
    def test_nget_returns_json(self, mock_req):
        from client.https import NGET, invalidate_cache
        invalidate_cache()
    ...
    def test_npatch_returns_json(self, mock_req):
        from client.https import NPATCH
    ...
    def test_error_raises_mapped_exception(self, mock_req):
        from client.https import NGET, invalidate_cache
        from client.errors import ObjectNotFound
        invalidate_cache()
    ...
    def test_invalidate_cache_called_on_post(self, mock_req):
        from client.https import NPOST, _cached_get, invalidate_cache
        invalidate_cache()
...
class TestNText(unittest.TestCase):
    ...
    def _make(self, content="hello", link=None):
        from nTypes.primitives import NText
...
class TestNEquation(unittest.TestCase):
    ...
    def test_read(self):
        from nTypes.primitives import NEquation
...
class TestNRichText(unittest.TestCase):
    ...
    def test_type(self):
        from nTypes.rich_text import NRichText
    ...
    def test_schema_error_on_missing_key(self):
        from nTypes.rich_text import NRichText, RichTextSchemaError
...
class TestNRichList(unittest.TestCase):
    ...
    def test_append_valid(self):
        from nTypes.rich_text import NRichList, NRichText
        rl = NRichList()
        item = {
            "type": "text",
...
class TestFiles(unittest.TestCase):
    ...
    def test_n_file_file(self):
        from nTypes.files import n_file, FileTypeFile
    ...
    def test_n_file_uploaded(self):
        from nTypes.files import n_file, FileTypeUploaded
...
class TestIcons(unittest.TestCase):
    ...
    def test_ncustom_emoji(self):
        from nTypes.icons import NCustomEmoji
...
class TestPropertyFactory(unittest.TestCase):
    ...
    def test_checkbox(self):
        from nTypes.page_properties import PropertyFactory, CheckboxProperty
    ...
    def test_select(self):
        from nTypes.page_properties import PropertyFactory, SelectProperty
        p = PropertyFactory.from_data("P", self._prop("select", {"select": {"name": "High"}}))
        self.assertEqual(p.value, "High")

    def test_multi_select(self):
        from nTypes.page_properties import PropertyFactory, MultiSelectProperty
    ...
    def test_status(self):
        from nTypes.page_properties import PropertyFactory
    ...
    def test_date_with_start(self):
        from nTypes.page_properties import PropertyFactory, DateProperty
    ...
    def test_formula_number(self):
        from nTypes.page_properties import PropertyFactory, FormulaProperty
    ...
    def test_rollup(self):
        from nTypes.page_properties import PropertyFactory, RollupProperty
    ...
    def test_unique_id(self):
        from nTypes.page_properties import PropertyFactory, UniqueIDProperty
    ...
    def test_created_time(self):
        from nTypes.page_properties import PropertyFactory, CreatedTimeProperty
    ...
    def test_last_edited_time(self):
        from nTypes.page_properties import PropertyFactory, LastEditedTimeProperty
    ...
    def test_created_by(self):
        from nTypes.page_properties import PropertyFactory, CreatedByProperty
    ...
    def test_files_readonly(self):
        from nTypes.page_properties import PropertyFactory, FilesProperty
    ...
    def test_verification(self):
        from nTypes.page_properties import PropertyFactory, VerificationProperty
    ...
    def test_button(self):
        from nTypes.page_properties import PropertyFactory, ButtonProperty
        p = PropertyFactory.from_data("B", self._prop("button", {"button": {}}))
        self.assertIsInstance(p, ButtonProperty)
        self.assertIsNone(p.value)

    def test_location(self):
        from nTypes.page_properties import PropertyFactory, LocationProperty
    ...
    def test_place(self):
        from nTypes.page_properties import PropertyFactory, PlaceProperty
    ...
    def test_last_visited_time(self):
        from nTypes.page_properties import PropertyFactory, LastVisitedTimeProperty
    ...
    def test_title_payload(self):
        from nTypes.page_properties import TitleProperty
    ...
    def test_date_payload_with_end(self):
        from nTypes.page_properties import DateProperty
        from nTypes.primitives import NDate
    ...
    def test_relation_payload(self):
        from nTypes.page_properties import RelationProperty
    ...
    def test_people_payload(self):
        from nTypes.page_properties import PeopleProperty
...
class TestBlockRegistry(unittest.TestCase):
    ...
    def test_all_expected_types_registered(self):
        from nModels.blocks.base_block import _ensure_registry_populated, _BLOCK_REGISTRY
    ...
    def test_unsupported_block_fallback(self):
        from nModels.blocks.base_block import BlockFactory, UnsupportedBlock
...
class TestMediaBlocks(unittest.TestCase):
    ...
    def test_audio_create_raises(self):
        from nModels.blocks.media import Audio
...
class TestTableBlocks(unittest.TestCase):
    ...
    def _make_row(self, *texts):
        from nModels.blocks.table import TableRowBlock
        from nTypes.rich_text import simple_rich_text_list
    ...
    def test_table_create(self):
        from nModels.blocks.table import TableBlock
...
class TestSpecialBlocks(unittest.TestCase):
    ...
    def test_code_create(self):
        ...
        from utils.constants import NLanguage
    ...
    def test_breadcrumb_create(self):
        from nModels.blocks.special_blocks import BreadcrumbBlock
    ...
    def test_child_page_create(self):
        from nModels.blocks.special_blocks import ChildPageBlock
    ...
    def test_child_database_create(self):
        from nModels.blocks.special_blocks import ChildDatabaseBlock
    ...
    def test_synced_block_no_source(self):
        from nModels.blocks.special_blocks import SyncedBlock
    ...
    def test_link_to_page_readonly(self):
        from nModels.blocks.special_blocks import LinkToPageBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_link_preview_readonly(self):
        from nModels.blocks.special_blocks import LinkPreviewBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_column_list_create(self):
        from nModels.blocks.special_blocks import ColumnListBlock
        b = ColumnListBlock.create()
        self.assertIsInstance(b, ColumnListBlock)

    def test_column_create(self):
        from nModels.blocks.special_blocks import ColumnBlock
    ...
    def test_append_children_isinstance_filter(self):
        ...
        from nModels.blocks.special_blocks import ChildPageBlock, ChildDatabaseBlock
        from nModels.blocks.paragraph import ParagraphBlock
...
class TestMeetingNotesBlock(unittest.TestCase):
    ...
    def test_from_data_ready(self):
        from nModels.blocks.meeting_notes import MeetingNotesBlock, MeetingNotesStatus
    ...
    def test_attendees(self):
        from nModels.blocks.meeting_notes import MeetingNotesBlock
...
class TestSimplePage(unittest.TestCase):
    ...
    def test_apply_sets_title(self):
        from nModels.pages import SimplePage
...
class TestPageFactory(unittest.TestCase):
    ...
    def test_routes_page_parent_to_simple(self, mock_req):
        from nModels.pages import PageFactory, SimplePage
        from client.https import invalidate_cache
        invalidate_cache()
        raw = {
    ...
    def test_routes_database_parent_to_database_page(self, mock_req):
        from nModels.pages import PageFactory, DatabasePage
        from client.https import invalidate_cache
        invalidate_cache()
        raw = {
            "object": "page", "id": "2a7b7a8f729480b3b420f8736c4116d7",
...
class TestNDatabase(unittest.TestCase):
    ...
    def test_apply_title(self):
        from nModels.databases import NDatabase
...
class TestDataSourceTemplate(unittest.TestCase):
    ...
    def test_properties(self):
        from nModels.datasources import DataSourceTemplate
...
class TestNUser(unittest.TestCase):
    ...
    def test_person_email(self, mock_req):
        from nModels.user import UserFactory, NPerson
        from client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response(self._person_raw())
        u = UserFactory.create({}, "aaaa0001" * 4)
    ...
    def test_bot_user(self, mock_req):
        from nModels.user import UserFactory, NBotUser
        from client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_bot_workspace(self, mock_req):
        from nModels.user import UserFactory, NBotWorkspace
        from client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_unknown_type_raises(self, mock_req):
        from nModels.user import UserFactory, UserError
        from client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
...
class TestNObjBlock(unittest.TestCase):
    ...
    def test_nfactory_unsupported_fallback(self, mock_req):
        from nModels.blocks.base_block import NFactory, UnsupportedBlock
        from client.https import invalidate_cache
        invalidate_cache()
        raw = {
            "object": "block",
...
class TestNObjProperties(unittest.TestCase):
    ...
    def test_object_type(self, mock_req):
        from nModels.base_object import NObjPage
        from client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
            "object": "page",
