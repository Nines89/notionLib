...
class TestHttpsLayer(unittest.TestCase):
    ...
    def setUp(self):
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()

    @patch("requests.request")
    def test_nget_returns_json(self, mock_req):
        from src.notion_lib.client.https import NGET, invalidate_cache
        invalidate_cache()
    ...
    def test_npatch_returns_json(self, mock_req):
        from src.notion_lib.client.https import NPATCH
    ...
    def test_error_raises_mapped_exception(self, mock_req):
        from src.notion_lib.client.https import NGET, invalidate_cache
        from src.notion_lib.client.errors import ObjectNotFound
        invalidate_cache()
    ...
    def test_invalidate_cache_called_on_post(self, mock_req):
        from src.notion_lib.client.https import NPOST, _cached_get, invalidate_cache
        invalidate_cache()
...
class TestNText(unittest.TestCase):
    ...
    def _make(self, content="hello", link=None):
        from src.notion_lib.nTypes.primitives import NText
...
class TestNEquation(unittest.TestCase):
    ...
    def test_read(self):
        from src.notion_lib.nTypes.primitives import NEquation
...
class TestNRichText(unittest.TestCase):
    ...
    def test_type(self):
        from src.notion_lib.nTypes.rich_text import NRichText
    ...
    def test_schema_error_on_missing_key(self):
        from src.notion_lib.nTypes.rich_text import NRichText, RichTextSchemaError
...
class TestNRichList(unittest.TestCase):
    ...
    def test_append_valid(self):
        from src.notion_lib.nTypes.rich_text import NRichList, NRichText
        rl = NRichList()
        item = {
            "type": "text",
    ...
    def test_append_invalid_raises(self):
        from src.notion_lib.nTypes.rich_text import NRichList
        rl = NRichList()
        with self.assertRaises(ValueError):
...
class TestFiles(unittest.TestCase):
    ...
    def test_uploaded_type(self):
        from src.notion_lib.nTypes.files import FileTypeUploaded
        f = FileTypeUploaded("upload-id-123")
        self.assertEqual(f.type, "file_upload")
        self.assertEqual(f.id, "upload-id-123")

    def test_file_type(self):
        from src.notion_lib.nTypes.files import FileTypeFile
    ...
    def test_n_file_file(self):
        from src.notion_lib.nTypes.files import n_file, FileTypeFile
...
class TestIcons(unittest.TestCase):
    ...
    def test_ncustom_emoji(self):
        from src.notion_lib.nTypes.icons import NCustomEmoji
    ...
    def test_nemoji_factory_emoji(self):
        from src.notion_lib.nTypes.icons import NEmojiFactory, NEmoji
        e = NEmojiFactory.find({"type": "emoji", "emoji": "🔥"})
        self.assertIsInstance(e, NEmoji)

    def test_nemoji_factory_custom(self):
        from src.notion_lib.nTypes.icons import NEmojiFactory, NCustomEmoji
    ...
    def test_nemoji_factory_unknown_raises(self):
        from src.notion_lib.nTypes.icons import NEmojiFactory, EmojiError
        with self.assertRaises(EmojiError):
            NEmojiFactory.find({"type": "unknown"})

    def test_icon_factory_emoji(self):
        from src.notion_lib.nTypes.icons import IconFactory, NEmoji
...
class TestPropertyFactory(unittest.TestCase):
    ...
    def test_title(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, TitleProperty
        p = PropertyFactory.from_data("Name", self._prop("title", {"title": []}))
        self.assertIsInstance(p, TitleProperty)

    def test_rich_text(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, RichTextProperty
        p = PropertyFactory.from_data("Desc", self._prop("rich_text", {"rich_text": []}))
        self.assertIsInstance(p, RichTextProperty)

    def test_number(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, NumberProperty
    ...
    def test_checkbox(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, CheckboxProperty
    ...
    def test_select(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory
    ...
    def test_date_with_start(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, DateProperty
    ...
    def test_formula_number(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, FormulaProperty
    ...
    def test_rollup(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, RollupProperty
    ...
    def test_unique_id(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, UniqueIDProperty
    ...
    def test_created_time(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, CreatedTimeProperty
    ...
    def test_last_edited_time(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, LastEditedTimeProperty
    ...
    def test_created_by(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, CreatedByProperty
    ...
    def test_files_readonly(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, FilesProperty
    ...
    def test_verification(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, VerificationProperty
    ...
    def test_button(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, ButtonProperty
        p = PropertyFactory.from_data("B", self._prop("button", {"button": {}}))
        self.assertIsInstance(p, ButtonProperty)
        self.assertIsNone(p.value)

    def test_location(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, LocationProperty
    ...
    def test_place(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, PlaceProperty
    ...
    def test_last_visited_time(self):
        from src.notion_lib.nTypes.page_properties import PropertyFactory, LastVisitedTimeProperty
    ...
    def test_title_payload(self):
        from src.notion_lib.nTypes.page_properties import TitleProperty
    ...
    def test_number_payload(self):
        from src.notion_lib.nTypes.page_properties import NumberProperty
        p = NumberProperty.from_data("Score", "id", {"number": 10})
        p.value = 99
        self.assertEqual(p.to_payload()["Score"]["number"], 99)

    def test_checkbox_payload(self):
        from src.notion_lib.nTypes.page_properties import CheckboxProperty
    ...
    def test_select_payload_none(self):
        from src.notion_lib.nTypes.page_properties import SelectProperty
        p = SelectProperty.from_data("P", "id", {"select": None})
        p.value = None
        self.assertIsNone(p.to_payload()["P"]["select"])

    def test_multi_select_payload(self):
        from src.notion_lib.nTypes.page_properties import MultiSelectProperty
    ...
    def test_date_payload_with_end(self):
        from src.notion_lib.nTypes.page_properties import DateProperty
    ...
    def test_relation_payload(self):
        from src.notion_lib.nTypes.page_properties import RelationProperty
    ...
    def test_people_payload(self):
        from src.notion_lib.nTypes.page_properties import PeopleProperty
...
class TestBlockRegistry(unittest.TestCase):
    ...
    def test_all_expected_types_registered(self):
        from src.notion_lib.nModels.blocks.base_block import _ensure_registry_populated, _BLOCK_REGISTRY
    ...
    def test_unsupported_block_fallback(self):
        from src.notion_lib.nModels.blocks.base_block import BlockFactory, UnsupportedBlock
...
class TestHeadingBlocks(unittest.TestCase):
    ...
    def test_heading1_create(self):
        from src.notion_lib.nModels.blocks.heading import Heading1
        b = Heading1.create("Title")
        p = b.to_payload()
        self.assertIn("heading_1", p)

    def test_heading2_create(self):
        from src.notion_lib.nModels.blocks.heading import Heading2
...
class TestMediaBlocks(unittest.TestCase):
    ...
    def test_audio_create_raises(self):
        from src.notion_lib.nModels.blocks.media import Audio
...
class TestTableBlocks(unittest.TestCase):
    ...
    def _make_row(self, *texts):
        from src.notion_lib.nModels.blocks.table import TableRowBlock
        from src.notion_lib.nTypes.rich_text import simple_rich_text_list
    ...
    def test_table_create(self):
        from src.notion_lib.nModels.blocks.table import TableBlock
...
class TestSpecialBlocks(unittest.TestCase):
    ...
    def test_code_create(self):
        ...
        from src.notion_lib.utils.constants import NLanguage
    ...
    def test_breadcrumb_create(self):
        from src.notion_lib.nModels.blocks.special_blocks import BreadcrumbBlock
    ...
    def test_child_page_create(self):
        from src.notion_lib.nModels.blocks.special_blocks import ChildPageBlock
    ...
    def test_child_database_create(self):
        from src.notion_lib.nModels.blocks.special_blocks import ChildDatabaseBlock
    ...
    def test_synced_block_no_source(self):
        from src.notion_lib.nModels.blocks.special_blocks import SyncedBlock
    ...
    def test_link_to_page_readonly(self):
        from src.notion_lib.nModels.blocks.special_blocks import LinkToPageBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_link_preview_readonly(self):
        from src.notion_lib.nModels.blocks.special_blocks import LinkPreviewBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_column_list_create(self):
        from src.notion_lib.nModels.blocks.special_blocks import ColumnListBlock
        b = ColumnListBlock.create()
        self.assertIsInstance(b, ColumnListBlock)

    def test_column_create(self):
        from src.notion_lib.nModels.blocks.special_blocks import ColumnBlock
    ...
    def test_append_children_isinstance_filter(self):
        ...
        from src.notion_lib.nModels.blocks.special_blocks import ChildPageBlock, ChildDatabaseBlock
        from src.notion_lib.nModels.blocks.paragraph import ParagraphBlock
...
class TestMeetingNotesBlock(unittest.TestCase):
    ...
    def test_from_data_ready(self):
        from src.notion_lib.nModels.blocks.meeting_notes import MeetingNotesBlock, MeetingNotesStatus
    ...
    def test_from_data_in_progress(self):
        from src.notion_lib.nModels.blocks.meeting_notes import MeetingNotesBlock
...
class TestSimplePage(unittest.TestCase):
    ...
    def test_apply_sets_title(self):
        from src.notion_lib.nModels.pages import SimplePage
...
class TestNDatabase(unittest.TestCase):
    ...
    def test_apply_title(self):
        from src.notion_lib.nModels.databases import NDatabase
...
class TestDataSourceTemplate(unittest.TestCase):
    ...
    def test_properties(self):
        from src.notion_lib.nModels.datasources import DataSourceTemplate
...
class TestNUser(unittest.TestCase):
    ...
    def test_person_email(self, mock_req):
        from src.notion_lib.nModels.user import UserFactory, NPerson
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response(self._person_raw())
        u = UserFactory.create({}, "aaaa0001" * 4)
    ...
    def test_bot_user(self, mock_req):
        from src.notion_lib.nModels.user import UserFactory, NBotUser
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_bot_workspace(self, mock_req):
        from src.notion_lib.nModels.user import UserFactory, NBotWorkspace
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_unknown_type_raises(self, mock_req):
        from src.notion_lib.nModels.user import UserFactory, UserError
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
...
class TestNObjBlock(unittest.TestCase):
    ...
    def test_nfactory_unsupported_fallback(self, mock_req):
        from src.notion_lib.nModels.blocks.base_block import NFactory, UnsupportedBlock
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
        raw = {
            "object": "block",
...
class TestNObjProperties(unittest.TestCase):
    ...
    def test_object_type(self, mock_req):
        from src.notion_lib.nModels.base_object import NObjPage
        from src.notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
            "object": "page",
