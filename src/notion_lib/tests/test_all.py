...
class TestCheckUrlOrId(unittest.TestCase):
    ...
    def test_plain_32_hex(self):
        notion_lib.utils.utils import check_url_or_id
...
class TestResolveResponse(unittest.TestCase):
    ...
    def test_dict_passthrough(self):
        notion_lib.utils.utils import resolve_response
        d = {"a": 1, "b": 2}
...
class TestHttpsLayer(unittest.TestCase):
    ...
    def setUp(self):
        notion_lib.client.https import invalidate_cache
        invalidate_cache()

    @patch("requests.request")
    def test_nget_returns_json(self, mock_req):
        notion_lib.client.https import NGET, invalidate_cache
        invalidate_cache()
    ...
    def test_npost_returns_json(self, mock_req):
        notion_lib.client.https import NPOST
    ...
    def test_npatch_returns_json(self, mock_req):
        notion_lib.client.https import NPATCH
    ...
    def test_error_raises_mapped_exception(self, mock_req):
        notion_lib.client.https import NGET, invalidate_cache
        notion_lib.client.errors import ObjectNotFound
        invalidate_cache()
    ...
    def test_invalidate_cache_called_on_post(self, mock_req):
        notion_lib.client.https import NPOST, _cached_get, invalidate_cache
        invalidate_cache()
...
class TestNDate(unittest.TestCase):
    ...
    def test_from_iso_string(self):
        notion_lib.nTypes.primitives import NDate
...
class TestNText(unittest.TestCase):
    ...
    def _make(self, content="hello", link=None):
        notion_lib.nTypes.primitives import NText
...
class TestNEquation(unittest.TestCase):
    ...
    def test_read(self):
        notion_lib.nTypes.primitives import NEquation
...
class TestNRichText(unittest.TestCase):
    ...
    def test_type(self):
        notion_lib.nTypes.rich_text import NRichText
    ...
    def test_schema_error_on_missing_key(self):
        notion_lib.nTypes.rich_text import NRichText, RichTextSchemaError
...
class TestNRichList(unittest.TestCase):
    ...
    def test_append_valid(self):
        notion_lib.nTypes.rich_text import NRichList, NRichText
        rl = NRichList()
        item = {
            "type": "text",
    ...
    def test_append_invalid_raises(self):
        notion_lib.nTypes.rich_text import NRichList
        rl = NRichList()
        with self.assertRaises(ValueError):
...
class TestCreateRichList(unittest.TestCase):
    ...
    def test_empty_list(self):
        notion_lib.nTypes.rich_text import create_rich_list
...
class TestIcons(unittest.TestCase):
    ...
    def test_ncustom_emoji(self):
        notion_lib.nTypes.icons import NCustomEmoji
    ...
    def test_nemoji_factory_emoji(self):
        notion_lib.nTypes.icons import NEmojiFactory, NEmoji
        e = NEmojiFactory.find({"type": "emoji", "emoji": "🔥"})
        self.assertIsInstance(e, NEmoji)

    def test_nemoji_factory_custom(self):
        notion_lib.nTypes.icons import NEmojiFactory, NCustomEmoji
...
class TestSortS(unittest.TestCase):
    ...
    def test_single_ascending(self):
        notion_lib.nTypes.ds_filters import S
        s = S().get(("Name", True))
...
class TestPropertyFactory(unittest.TestCase):
    ...
    def test_title(self):
        notion_lib.nTypes.page_properties import PropertyFactory, TitleProperty
        p = PropertyFactory.from_data("Name", self._prop("title", {"title": []}))
        self.assertIsInstance(p, TitleProperty)

    def test_rich_text(self):
        notion_lib.nTypes.page_properties import PropertyFactory, RichTextProperty
        p = PropertyFactory.from_data("Desc", self._prop("rich_text", {"rich_text": []}))
        self.assertIsInstance(p, RichTextProperty)

    def test_number(self):
        notion_lib.nTypes.page_properties import PropertyFactory, NumberProperty
    ...
    def test_checkbox(self):
        notion_lib.nTypes.page_properties import PropertyFactory, CheckboxProperty
    ...
    def test_select(self):
        notion_lib.nTypes.page_properties import PropertyFactory
    ...
    def test_date_with_start(self):
        notion_lib.nTypes.page_properties import PropertyFactory, DateProperty
    ...
    def test_formula_number(self):
        notion_lib.nTypes.page_properties import PropertyFactory, FormulaProperty
    ...
    def test_rollup(self):
        notion_lib.nTypes.page_properties import PropertyFactory, RollupProperty
    ...
    def test_unique_id(self):
        notion_lib.nTypes.page_properties import PropertyFactory, UniqueIDProperty
    ...
    def test_created_time(self):
        notion_lib.nTypes.page_properties import PropertyFactory, CreatedTimeProperty
    ...
    def test_last_edited_time(self):
        notion_lib.nTypes.page_properties import PropertyFactory, LastEditedTimeProperty
    ...
    def test_created_by(self):
        notion_lib.nTypes.page_properties import PropertyFactory, CreatedByProperty
    ...
    def test_files_readonly(self):
        notion_lib.nTypes.page_properties import PropertyFactory, FilesProperty
    ...
    def test_verification(self):
        notion_lib.nTypes.page_properties import PropertyFactory, VerificationProperty
    ...
    def test_button(self):
        notion_lib.nTypes.page_properties import PropertyFactory, ButtonProperty
        p = PropertyFactory.from_data("B", self._prop("button", {"button": {}}))
        self.assertIsInstance(p, ButtonProperty)
        self.assertIsNone(p.value)

    def test_location(self):
        notion_lib.nTypes.page_properties import PropertyFactory, LocationProperty
    ...
    def test_place(self):
        notion_lib.nTypes.page_properties import PropertyFactory, PlaceProperty
    ...
    def test_last_visited_time(self):
        notion_lib.nTypes.page_properties import PropertyFactory, LastVisitedTimeProperty
    ...
    def test_title_payload(self):
        notion_lib.nTypes.page_properties import TitleProperty
    ...
    def test_date_payload_with_end(self):
        notion_lib.nTypes.page_properties import DateProperty
    ...
    def test_relation_payload(self):
        notion_lib.nTypes.page_properties import RelationProperty
    ...
    def test_people_payload(self):
        notion_lib.nTypes.page_properties import PeopleProperty
...
class TestBlockRegistry(unittest.TestCase):
    ...
    def test_all_expected_types_registered(self):
        notion_lib.nModels.blocks.base_block import _ensure_registry_populated, _BLOCK_REGISTRY
    ...
    def test_unsupported_block_fallback(self):
        notion_lib.nModels.blocks.base_block import BlockFactory, UnsupportedBlock
...
class TestParagraphBlock(unittest.TestCase):
    ...
    def test_color_setter(self):
        notion_lib.nModels.blocks.paragraph import ParagraphBlock
        notion_lib.utils.constants import NColors
...
class TestMediaBlocks(unittest.TestCase):
    ...
    def test_audio_create_raises(self):
        notion_lib.nModels.blocks.media import Audio
...
class TestTableBlocks(unittest.TestCase):
    ...
    def _make_row(self, *texts):
        notion_lib.nModels.blocks.table import TableRowBlock
        notion_lib.nTypes.rich_text import simple_rich_text_list
    ...
    def test_table_create(self):
        notion_lib.nModels.blocks.table import TableBlock
...
class TestSpecialBlocks(unittest.TestCase):
    ...
    def test_code_create(self):
        ...
        notion_lib.utils.constants import NLanguage
    ...
    def test_breadcrumb_create(self):
        notion_lib.nModels.blocks.special_blocks import BreadcrumbBlock
    ...
    def test_child_page_create(self):
        notion_lib.nModels.blocks.special_blocks import ChildPageBlock
    ...
    def test_child_database_create(self):
        notion_lib.nModels.blocks.special_blocks import ChildDatabaseBlock
    ...
    def test_synced_block_no_source(self):
        notion_lib.nModels.blocks.special_blocks import SyncedBlock
    ...
    def test_link_to_page_readonly(self):
        notion_lib.nModels.blocks.special_blocks import LinkToPageBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_link_preview_readonly(self):
        notion_lib.nModels.blocks.special_blocks import LinkPreviewBlock
        with self.assertRaises(NotImplementedError):
    ...
    def test_column_list_create(self):
        notion_lib.nModels.blocks.special_blocks import ColumnListBlock
        b = ColumnListBlock.create()
        self.assertIsInstance(b, ColumnListBlock)

    def test_column_create(self):
        notion_lib.nModels.blocks.special_blocks import ColumnBlock
    ...
    def test_append_children_isinstance_filter(self):
        ...
        notion_lib.nModels.blocks.special_blocks import ChildPageBlock, ChildDatabaseBlock
        notion_lib.nModels.blocks.paragraph import ParagraphBlock
...
class TestMeetingNotesBlock(unittest.TestCase):
    ...
    def test_from_data_ready(self):
        notion_lib.nModels.blocks.meeting_notes import MeetingNotesBlock, MeetingNotesStatus
    ...
    def test_from_data_in_progress(self):
        notion_lib.nModels.blocks.meeting_notes import MeetingNotesBlock
...
class TestSimplePage(unittest.TestCase):
    ...
    def test_apply_sets_title(self):
        notion_lib.nModels.pages import SimplePage
...
class TestDatabasePage(unittest.TestCase):
    ...
    def test_apply_loads_properties(self):
        notion_lib.nModels.pages import DatabasePage
...
class TestPageFactory(unittest.TestCase):
    ...
    def test_routes_page_parent_to_simple(self, mock_req):
        notion_lib.nModels.pages import PageFactory, SimplePage
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        raw = {
    ...
    def test_routes_database_parent_to_database_page(self, mock_req):
        notion_lib.nModels.pages import PageFactory, DatabasePage
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        raw = {
            "object": "page", "id": "2a7b7a8f729480b3b420f8736c4116d7",
...
class TestNDatabase(unittest.TestCase):
    ...
    def test_apply_title(self):
        notion_lib.nModels.databases import NDatabase
...
class TestNDataSource(unittest.TestCase):
    ...
    def test_apply_title(self):
        notion_lib.nModels.datasources import NDataSource
...
class TestDataSourceTemplate(unittest.TestCase):
    ...
    def test_properties(self):
        notion_lib.nModels.datasources import DataSourceTemplate
...
class TestNUser(unittest.TestCase):
    ...
    def test_person_name(self, mock_req):
        notion_lib.nModels.user import UserFactory
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_person_email(self, mock_req):
        notion_lib.nModels.user import UserFactory, NPerson
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response(self._person_raw())
        u = UserFactory.create({}, "aaaa0001" * 4)
    ...
    def test_bot_user(self, mock_req):
        notion_lib.nModels.user import UserFactory, NBotUser
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_bot_workspace(self, mock_req):
        notion_lib.nModels.user import UserFactory, NBotWorkspace
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
    ...
    def test_unknown_type_raises(self, mock_req):
        notion_lib.nModels.user import UserFactory, UserError
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
...
class TestNObjBlock(unittest.TestCase):
    ...
    def test_nfactory_find_paragraph(self, mock_req):
        notion_lib.nModels.blocks.base_block import NFactory
        notion_lib.nModels.blocks.paragraph import ParagraphBlock
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        raw = {
    ...
    def test_nfactory_unsupported_fallback(self, mock_req):
        notion_lib.nModels.blocks.base_block import NFactory, UnsupportedBlock
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        raw = {
            "object": "block",
...
class TestNObjProperties(unittest.TestCase):
    ...
    def test_object_type(self, mock_req):
        notion_lib.nModels.base_object import NObjPage
        notion_lib.client.https import invalidate_cache
        invalidate_cache()
        mock_req.return_value = _fake_response({
            "object": "page",
